...
if exist "%PROJECT_DIR%\bin\*.exe" goto failed
if exist "%PROJECT_DIR%\bin\*.dat" del /f /q "%PROJECT_DIR%\bin\*.dat"
if exist "%PROJECT_DIR%\bin\*.dat" goto failed
if exist "%PROJECT_DIR%\bin\*.msi" del /f /q "%PROJECT_DIR%\bin\*.msi"
if exist "%PROJECT_DIR%\bin\*.msi" goto failed
